...
| 阶段 | 平台 | 目标 | 状态 |
|------|------|------|------|
| **Phase 1** | Web 应用 | 最快出效果，验证核心体验 | ✅ 已完成 |
| **Phase 2** | 桌面端 (Tauri) | 复用 Web 代码，提供原生体验 | ⏳ 待开发 |
| **Phase 3** | 移动端 (React Native / PWA) | 随时随地记录 | ✅ PWA 已实现 |
| **Phase 4** | 云端部署 | 微信云托管容器化，公网可访问 | ✅ 已上线 |
| **Phase 5** | 微信小程序 | Taro 跨平台，微信生态集成 | 🚧 基础架构完成 |
...
| 技术 | 用途 |
|------|------|
| **Next.js 16** (App Router) | 全栈框架，SSR/SSG 支持，standalone 输出 |
| **TypeScript** | 类型安全 |
| **Tailwind CSS v4** | 原子化样式 |
| **Supabase** | 认证(Auth) + 数据库(PostgreSQL) + 存储(Storage) |
| **Zustand** | 状态管理 (localStorage 持久化) |
| **Tiptap** | 富文本编辑器 |
| **Framer Motion** | 动画 |
| **Docker** | 容器化部署 (多阶段构建，node:20-alpine) |
| **微信云托管** | 生产环境托管 (容器编排 + 自动HTTPS + Git集成) |
| **GitHub** | 代码仓库 + 自动部署触发 |
| **Tiptap** | 可扩展的富文本编辑器 |
